...
class UserPolicy
{
    ...
    public function viewAny(User $user): Builder
    {
        ...
        return match (true) {
            ...
            $user->hasRole('operations logistics associate') 
                => $this->applyScopedQuery($user, ['shipper', 'carrier'.'marketing logistics associate','procurement logistics associate']),

            $user->hasRole('logistics operations executive') 
                => $this->applyScopedQuery($user, ['shipper', 'carrier'.'marketing logistics associate','procurement logistics associate','operations logistics associate']),           
    ...
    public function view(User $auth, User $target): bool
    {
        ...
        $targetRoles = match (true) {
            ...
            $auth->hasRole('operations logistics associate') => ['carrier','shipper','marketing logistics associate','procurement logistics associate'],
            $auth->hasRole('logistics operations executive') => ['carrier','shipper','marketing logistics associate','procurement logistics associate','operations logistics associate'], 
            default => null
        };
