<section id="curved-steps" class="relative overflow-hidden">
    <div class="mt-2 md:mt-0 py-4 pb-6 sm:py-8 lg:pb-8 overflow-hidden">
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative">
            <div class="relative mt-2 lg:mt-20">
                <div class="absolute inset-x-0 hidden xl:px-44 md:block md:px-20 lg:px-28">
                    ...
                    <div>
                        ...
                        <p class="mt-3 sm:mt-4 text-base text-gray-600 dark:text-gray-400">
                            <ul  class="list-disc list-inside space-y-2 ml-4">
                                <li>
 <a href="/register" class="text-indigo-600 dark:text-indigo-400 hover:underline">Register</a> for a Transpartner Logistics' account or <a href="/login" class="text-indigo-600 dark:text-indigo-400 hover:underline">login</a> if already registered.                                    
                                </li>
                                <li>
                    ...
                    <div>
                        ...
                        <h3
                            class="mt-4 sm:mt-6 text-xl font-semibold leading-tight text-gray-900 dark:text-white md:mt-10">
                            Review and Negotiate the Rate
                        </h3>
                        <p class="mt-3 sm:mt-4 text-base text-gray-600 dark:text-gray-400">
                           <ul class="list-disc list-inside space-y-2 ml-4">
                            <li>Reviewing Load Details & Price:</li>
                            <li>Propose a <span class="font-semibold">bid</span> or counter-offer</li>
                           </ul>
                        </p>
                    </div>
                    <div>
                        ...
                        <p class="mt-3 sm:mt-4 text-base text-gray-600 dark:text-gray-400">
                           <ul class="list-disc list-inside space-y-2 ml-4">
                            <li>receive a <span class="font-semibold"> Confirmation document</span></li>
                            <li>and the  <span class="font-semibold">Bill of Laden</span></li>
                           </ul>
                        </p>
                    </div>
                </div>
