@props(['name'])
   ...
   {{--verified tick  --}}
	...
	@elseif ($name=='facebook')
		<svg {{ $attributes->merge(['class' => '', 'stroke-width' => '']) }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
	...
	{{-- umbrella --}}
	@elseif ($name=='umbrella')
		<svg {{ $attributes->merge(['class' => '', 'stroke-width' => '']) }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
			<path stroke-linecap="round" stroke-linejoin="round" d="M12 2C7.03 2 3 6.03 3 11c0 .55.45 1 1 1h7v9c0 .55.45 1 1 1s1-.45 1-1v-9h7c.55 0 1-.45 1-1 0-4.97-4.03-9-9-9z" />
		</svg>	
	{{-- linked in --}}
	@elseif ($name=='linkedin')
		<svg {{ $attributes->merge(['class' => '', 'stroke-width' => '']) }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
			<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 3a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h14zM8.5 8.25V15.75M15.5 8.25V15.75M9 8.25a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zm6.75 3.75l-3 3.75m0 0l-3-3.75m3 3.75V8.25" />
		</svg>
