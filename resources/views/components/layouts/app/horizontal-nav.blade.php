...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    ...
    <flux:header container class="bg-zinc-50 dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-700">
        ...
        <flux:navbar class="-mb-px max-lg:hidden">
            ...
            <flux:dropdown class="max-lg:hidden">
                <flux:navbar.item icon:trailing="chevron-down"
                    :current="request()->routeIs('lanes.index') || request()->routeIs('freights.index') || request()->routeIs('consultancy')  ">
                    Services</flux:navbar.item>
                <flux:navmenu>
                    <flux:navmenu.item icon="truck" :href="route('lanes.index')"
                        :current="request()->routeIs('lanes.index')" wire:navigate>
                        {{ __('Available Vehicles') }}
                    </flux:navmenu.item>
                    <flux:navmenu.item icon="cube" :href="route('freights.index')"
                        :current="request()->routeIs('freights.index')" wire:navigate>
                        {{ __('Available Loads') }}
                    </flux:navmenu.item>
                    <flux:navmenu.item icon="arrow-trending-up" :href="route('consultancy')"
                        :current="request()->routeIs('consultancy')" wire:navigate>
                        {{ __('Consultancy') }}
                    </flux:navmenu.item>
                </flux:navmenu>
            </flux:dropdown>
            ...
            <flux:navbar.item icon="envelope" href="http://webmail.transpartnerlogistics.co.zw/" target="_blank"
                wire:navigate>
                {{ __('Webmail') }}
            </flux:navbar.item>
        </flux:navbar>
        ...
        <flux:dropdown position="top" align="start">
            <flux:navbar.item icon:trailing="chevron-down"
                :current="request()->routeIs('login') || request()->routeIs('register')">
                <x-graphic name="user" class="size-6" />
            </flux:navbar.item>
            <flux:navmenu>
                <flux:navmenu.item icon="key" :href="route('login')" :current="request()->routeIs('login')"
                    wire:navigate>
                    {{ __('Login') }}
                </flux:navmenu.item>
                <flux:navmenu.item icon="lock-open" :href="route('register')"
    ...
    <flux:sidebar sticky collapsible="mobile"
        ...
        <flux:sidebar.nav>
            ...
            <flux:sidebar.item icon="user-group" :href="route('about-us')" :current="request()->routeIs('about-us')"
                wire:navigate>
                About Us
            </flux:sidebar.item>
            ...
            <flux:sidebar.item icon="scale" :href="route('terms')" :current="request()->routeIs('terms')"
                wire:navigate>
                {{ __('Terms') }}
            </flux:sidebar.item>

            <flux:sidebar.item icon="envelope" href="http://webmail.transpartnerlogistics.co.zw/" target="_blank"
                wire:navigate>
                {{ __('Webmail') }}
            </flux:sidebar.item>

            <flux:sidebar.group expandable heading="Services" class="grid"
                :current="request()->routeIs('lanes.index') || request()->routeIs('freights.index') || request()->routeIs('consultancy')  ">
                <flux:sidebar.item icon="truck" :href="route('lanes.index')"
                    :current="request()->routeIs('lanes.index')" wire:navigate>
                    {{ __('Available Vehicles') }}
                </flux:sidebar.item>
                <flux:sidebar.item icon="cube" :href="route('freights.index')"
                    :current="request()->routeIs('freights.index')" wire:navigate>
                    {{ __('Available Loads') }}
                </flux:sidebar.item>
                <flux:sidebar.item icon="arrow-trending-up" :href="route('consultancy')"
                    :current="request()->routeIs('consultancy')" wire:navigate>
                    {{ __('Consultancy') }}
                </flux:sidebar.item>
            </flux:sidebar.group>
        ...
        <flux:sidebar.nav>
            <div class="px-2 py-4 border-t border-zinc-200 dark:border-zinc-700">
                <h3 class="text-xs font-bold uppercase mb-3 text-zinc-500 dark:text-zinc-500">{{ __('Get In Touch') }}
                </h3>
