...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    ...
    <flux:sidebar sticky collapsible class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">        
        ...
        <flux:navlist variant="outline">
            <flux:navlist.item icon="user-group" :href="route('about-us')" :current="request()->routeIs('about-us')"
                wire:navigate>
                {{ __('About Us') }}
            </flux:navlist.item>
        </flux:navlist>
        ...
        <flux:navlist.group variant="outline"  heading="SERVICES"
            ...
            <flux:navlist.item icon="cube" :href="route('freights.index')"
                :current="request()->routeIs('freights.index')" wire:navigate>
                {{ __('Available Loads') }}
            </flux:navlist.item>
            <flux:navlist.item icon="arrow-trending-up" :href="route('consultancy')"
        ...
        <flux:navlist variant="outline">
            <flux:navlist.item icon="question-mark-circle" :href="route('faq')" :current="request()->routeIs('faq')"
                wire:navigate>
                {{ __('F.A.Q') }}
            </flux:navlist.item>
        </flux:navlist>
        ...
        <flux:dropdown class="hidden lg:block" position="bottom" align="start">
            <flux:profile :name="auth()->user()->contact_person" :initials="auth()->user()->initials()"
