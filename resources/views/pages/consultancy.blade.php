        ...
        @php
            ...
            $services = [
                ...
                [
                    ...
                    'icon' => 'chart-bar-square', // Heroicon-o-magnifying-glass-chart
                    'list' => [
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div
                    ...
                    <p class="mt-4 text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
                        Transpartner Logistics' highly motivated and experienced team is on hot standby to impart a
                        competitive edge by offering a wide range of transport consultancy services.
                        Be it starting and managing freight or passenger companies, driver management, extended freight
                        forwarding, market research, or training services; <span class="font-semibold"> we are ready for
                            you.</span>
                    </p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    @foreach ($services as $service)
                        <div
                            class="bg-white dark:bg-gray-800 rounded-xl shadow-xl transition duration-300 ease-in-out transform hover:scale-[1.02] hover:shadow-2xl overflow-hidden group">


                            <div
                                class="p-6 bg-indigo-600 dark:bg-indigo-700 text-white flex items-center justify-center h-40">
                                <flux:icon :name="$service['icon']"
                            ...
                            <div class="p-6">
                                ...
                                <p
                                    class="text-sm font-semibold text-indigo-600 dark:text-indigo-400 mb-4 uppercase tracking-wider">
                                    Services Include:
                                </p>
                            ...
                            <div class="p-6 pt-0 border-t border-gray-100 dark:border-gray-700">
                                @auth
                                    ...
                                    <button
                                        ...
                                        data-toggle="modal" data-target="#consulModal"
