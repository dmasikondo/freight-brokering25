...
<div id="contact" x-data="{
    ...
    <div class="w-full max-w-7xl mt-8">
        <h1
            class="text-5xl font-bold text-center bg-gradient-to-r from-blue-400 to-purple-500 text-transparent bg-clip-text mb-4">
            Ship Smarter!!
        </h1>
                ...
                <div x-show="currentStep === 5" class="space-y-3">
                    ...
                    <div class="bg-gray-700/50 p-3 rounded-lg text-xs space-y-1">
                        ...
                        <div class="flex items-center gap-1.5"
                            :class="{ 'text-green-400': password.length >= 8, 'text-gray-300': password.length < 8 }">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5"
                                :class="{ 'text-green-400': password.length >= 8, 'text-gray-500': password.length < 8 }"
                        ...
                        <div class="flex items-center gap-1.5"
                            :class="{
                                'text-green-400': /[A-Z]/.test(password),
                                'text-gray-300': !/[A-Z]/.test(
                                    password)
                            }">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5"
                                :class="{
                                    'text-green-400': /[A-Z]/.test(password),
                                    'text-gray-500': !/[A-Z]/.test(
                                        password)
                                }"
                                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="flex items-center gap-1.5"
                            :class="{
                                'text-green-400': /[0-9]/.test(password),
                                'text-gray-300': !/[0-9]/.test(
                                    password)
                            }">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5"
                                :class="{
                                    'text-green-400': /[0-9]/.test(password),
                                    'text-gray-500': !/[0-9]/.test(
                                        password)
                                }"
                                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="mt-6 pt-4 border-t border-gray-700">
                    ...
                    <div class="space-y-2 text-xs">
                        ...
                        <div class="flex items-center gap-2" x-show="ownership_type">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5"
                                :class="{ 'text-yellow-400': ownership_type === 'real_owner', 'text-blue-400': ownership_type === 'broker_agent' }"
                                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path x-show="ownership_type === 'real_owner'" stroke-linecap="round"
                                    stroke-linejoin="round" stroke-width="2"
                                    d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                                <path x-show="ownership_type === 'broker_agent'" stroke-linecap="round"
                                    stroke-linejoin="round" stroke-width="2"
                                    d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" />
                            </svg>
                            <span x-text="ownership_type === 'real_owner' ? 'Real Owner' : 'Broker/Agent'"
                                class="text-gray-400"></span>
                        </div>
                        <div class="flex items-center gap-2" x-show="customer_type">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5"
                                :class="{ 'text-teal-400': customer_type === 'carrier', 'text-orange-400': customer_type === 'shipper' }"
                                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path x-show="customer_type === 'carrier'" stroke-linecap="round"
                                    stroke-linejoin="round" stroke-width="2"
                                    d="M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0z" />
                                <path x-show="customer_type === 'carrier'" stroke-linecap="round"
                                    stroke-linejoin="round" stroke-width="2"
                                    d="M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10a1 1 0 001 1h1m8-1a1 1 0 01-1 1H9m4-1V8a1 1 0 011-1h2.586a1 1 0 01.707.293l3.414 3.414a1 1 0 01.293.707V16a1 1 0 01-1 1h-1m-6-1a1 1 0 001 1h1M5 17a2 2 0 104 0m-4 0a2 2 0 114 0m6 0a2 2 0 104 0m-4 0a2 2 0 114 0" />
                                <path x-show="customer_type === 'shipper'" stroke-linecap="round"
                                    stroke-linejoin="round" stroke-width="2"
                                    d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                            </svg>
                            <span x-text="customer_type === 'carrier' ? 'Carrier' : 'Shipper'"
                                class="text-gray-400"></span>
                        </div>
            ...
            <div class="{{-- bg-gray-800 --}} p-8 rounded-3xl shadow-xl w-full md:w-1/2 order-1 md:order-2">
                <form wire:submit.prevent>
                    ...
                    <div x-show="currentStep===2">
                        <h2 class="text-2xl font-bold mb-6">
                            What's <span>{{ $isStaffRegistration ? "the user's" : 'your' }}</span> contact
                            details?
                        </h2>
                        <x-form.select @class(['border-red-500' => $errors->has('phone_type'), 'mb-4']) placeholder="Phone Type" model="phone_type"
                        ...
                        <x-form.input placeholder="Contact Phone Number" model="contact_phone"
                            wire:model="contact_phone" @class(['border-red-500' => $errors->has('contact_phone'), 'mb-4']) pattern="^\+?[1-9]\d{6,14}$"
                        ...
                        <x-form.input placeholder="WhatsApp (optional)" model="whatsapp" wire:model="whatsapp"
                            @class(['border-red-500' => $errors->has('whatsapp')]) pattern="^\+?[1-9]\d{6,14}$" required
                        ...
                        <div @class([
                            ...
                            <div class="flex flex-col mt-2">
                                ...
                                <p x-show="customer_type === 'carrier'"
                                    class="text-xs italic text-gray-400 ml-7 mt-1">You provide trucks/trailers
                                    to move goods</p>
                            </div>
                            <div class="flex flex-col mt-2">
                                <div class="flex items-center">
                                ...
                                <p x-show="customer_type === 'shipper'"
                                    class="text-xs italic text-gray-400 ml-7 mt-1">You have goods that need to
                                    be transported</p>
                            </div>
                    ...
                    <div x-show="currentStep===4   && (customer_type ==='carrier' || customer_type ==='shipper')"
                        x-cloak>
                        ...
                        <div x-show="country==='Zimbabwe'">
                            <x-form.select @class(['border-red-500' => $errors->has('city'), 'mb-4']) placeholder="City" wire:model="city"
                    ...
                    <div x-show="currentStep === 5">
                        ...
                        <x-form.input type="email" placeholder="Email" model="email" wire:model="email"
                            class="mb-4" @class(['border-red-500' => $errors->has('email'), 'mb-4']) required />
                    ...
                    <div class="flex justify-between mt-8">
                        ...
                        <button wire:click="nextStep" x-show="currentStep < 5"
                            class="px-6 py-3 bg-blue-600 hover:bg-blue-500 rounded-xl transition duration-300 ml-auto">
                            Next
                        </button>

                        <button wire:click="register" x-show="currentStep === 5"
                    ...
                    <div class="flex justify-center mt-8 gap-2">
                        <div class="h-2 w-8 rounded-full bg-blue-500"
                            :class="{ 'w-2 bg-gray-600': currentStep !== 1, 'w-8 bg-blue-500': currentStep === 1 }">
                        </div>
                        <div class="h-2 w-2 rounded-full"
                            :class="{ 'w-2 bg-gray-600': currentStep !== 2, 'w-8 bg-blue-500': currentStep === 2 }">
                        </div>
                        <div class="h-2 w-2 rounded-full"
                            :class="{ 'w-2 bg-gray-600': currentStep !== 3, 'w-8 bg-blue-500': currentStep === 3 }">
                        </div>
                        <div class="h-2 w-2 rounded-full"
                            :class="{ 'w-2 bg-gray-600': currentStep !== 4, 'w-8 bg-blue-500': currentStep === 4 }">
                        </div>
                        <div class="h-2 w-2 rounded-full"
                            :class="{ 'w-2 bg-gray-600': currentStep !== 5, 'w-8 bg-blue-500': currentStep === 5 }">
                        </div>
                    </div>
                </form>
            </div>
