...
new class extends Component {
    ...
    {
        return [($this->directors = $this->user->directors()->get()), ($this->numberOfDirectors = $this->directors->count())];
    }
                ...
                @foreach ($directors as $director)
                    ...
                    <div
                        ...
                        <flux:dropdown position="bottom" align="end">
                            ...
                            <flux:menu>
                                <flux:menu.item icon="pencil-square" class="hover:text-cyan-700 hover:bg-cyan-200">Edit
                                    Director
                                </flux:menu.item>
                                <flux:menu.separator />
                                <flux:menu.item variant="danger" icon="trash">Delete Director</flux:menu.item>
                            </flux:menu>
                        </flux:dropdown>
