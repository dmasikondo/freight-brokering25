...
<div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <!-- Directors Information Status -->
        <div class="bg-white dark:bg-slate-800 rounded-xl p-6 border border-gray-200 dark:border-slate-700">
            <div class="flex items-center justify-between mb-4">
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 bg-lime-100 rounded-full flex items-center justify-center dark:bg-lime-900">
                        <flux:icon name="users" class="w-5 h-5 text-lime-600 dark:text-lime-400" />
                    </div>
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Directors</h3>
                </div>
            ...
            <div class="space-y-2">
                <div class="flex items-center justify-between text-sm">
                    <span class="text-gray-600 dark:text-gray-400">Basic Information</span>
                    <flux:icon name="check-circle" class="w-4 h-4 text-green-500" />
                </div>
                <div class="flex items-center justify-between text-sm">
                    <span class="text-gray-600 dark:text-gray-400">Identification</span>
                    <flux:icon name="check-circle" class="w-4 h-4 text-green-500" />
                </div>
                <div class="flex items-center justify-between text-sm">
                    <span class="text-gray-600 dark:text-gray-400">Background Check</span>
                    <flux:icon name="check-circle" class="w-4 h-4 text-green-500" />
                </div>
            </div>

            <button class="w-full mt-4 px-4 py-2 border border-lime-500 text-lime-600 rounded-lg hover:bg-lime-50 transition-colors dark:border-lime-400 dark:text-lime-400 dark:hover:bg-lime-900/20">
