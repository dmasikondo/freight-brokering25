...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-lime-50 dark:from-slate-900 dark:to-slate-800 flex items-center justify-center p-4">
    <div class="max-w-md w-full text-center p-8 md:p-10 bg-white/80 backdrop-blur-sm border border-lime-200 rounded-3xl shadow-2xl transition-all duration-500 dark:bg-slate-800/80 dark:border-lime-500/30">
        
        <div class="mb-8">
            <h1 class="text-3xl font-black text-lime-600 tracking-wider dark:text-lime-400">
            ...
            <form method="POST" action="{{ route('login') }}" class="text-left">
                ...
                <div class="flex items-center justify-between mt-4">
                    <div class="flex items-center">
                        <input id="remember_me" type="checkbox" class="rounded border-gray-300 text-lime-600 shadow-sm focus:ring-lime-500 dark:bg-slate-700 dark:border-slate-600" name="remember">
