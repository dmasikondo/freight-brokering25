<x-layouts.app :title="__('Not Found - 404 | Transpartner Logistics')">
    ...
    <div
        ...
        <div
            class="max-w-xl w-full text-center p-8 md:p-12 bg-white/80 backdrop-blur-sm border border-lime-200 rounded-3xl shadow-2xl transition-all duration-500 dark:bg-slate-800/80 dark:border-lime-500/30">
            ...
            <div class="mb-10 flex justify-center">
                <div class="relative">
                    <div
                        class="w-64 h-48 bg-gradient-to-r from-lime-100 to-lime-200 rounded-2xl flex items-center justify-center shadow-inner dark:from-slate-700 dark:to-slate-600">
                        <span class="text-8xl font-black text-lime-500/70 dark:text-lime-400/50">404</span>
                    </div>
                    <div
                        class="absolute -top-4 -right-4 w-20 h-20 bg-lime-500 rounded-full flex items-center justify-center shadow-lg animate-bounce">
                        <flux:icon name="exclamation-triangle" class="text-white text-2xl"></flux:icon>
                    </div>
                    <div
                        class="absolute -bottom-4 -left-4 w-16 h-16 bg-lime-400 rounded-full flex items-center justify-center shadow-lg animate-pulse">
            ...
            <p class="text-lg text-gray-600 mb-10 max-w-md mx-auto leading-relaxed dark:text-gray-400">
                The page you're looking for has been rerouted or is no longer in service. Our logistics team has been
                notified.
            </p>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
                <a href="/"
                    class="px-8 py-4 bg-gradient-to-r from-lime-500 to-lime-600 text-white font-bold rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 flex items-center gap-2"
                    wire:navigate>
                    <flux:icon name="home" class="text-white"></flux:icon>
                    Return to Home
                </a>
                <a href="https://wa.me/263772930514"
                    class="px-6 py-4 bg-white text-lime-600 font-semibold border border-lime-300 rounded-full shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-105 flex items-center gap-2 dark:bg-slate-700 dark:text-lime-400 dark:border-lime-500/30"
                    wire:navigate>
            ...
            <div class="border-t border-gray-200 pt-6 dark:border-gray-700">
                ...
                <div class="flex flex-wrap justify-center gap-4">
                    <a href="/lanes"
                        class="text-lime-600 hover:text-lime-500 transition-colors duration-200 flex items-center gap-1 dark:text-lime-400"
                        wire:navigate>
